...
// ============================== GMJ ==============================
#pragma mark - 新增stop block (扫描超时:YES, 主动停止扫描:NO)
typedef void(^BBStopBlock)(BOOL);
@property (nonatomic, copy) BBStopBlock stopBlock;
// ============================== GMJ ==============================

/**
停止扫描block
*/
- (void)setBlockStop:(BBStopBlock)block;
