...
class MessagesTableView: BaseView {
    struct MessageData {
        /// 是否已读
        var isRead: Bool = true
        var bgImage: UIImage = kErrorImage
        var bgUrl: String = ""
        var typeImage: UIImage = UIImage(named: "hot")!
        var title: String = ""
        var time: String = ""
    ...
    private lazy var tableView: UITableView = {
        ...
        tableView.register(MessagesCell.classForCoder(), forCellReuseIdentifier: MessagesCell.description())
        return tableView
    }()
...
extension MessagesTableView: UITableViewDelegate, UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return configuration.dataList.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell: MessagesCell = tableView.dequeueReusableCell(withIdentifier: MessagesCell.description(), for: indexPath) as! MessagesCell
